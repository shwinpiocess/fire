...
urlpatterns = [
    ...
    url(r'nm/components/accountAction!saveAccount.action$', views.saveAccount, name='saveAccount'),
    url(r'nm/components/accountAction!deleteAccount.action$', views.deleteAccount, name='deleteAccount'),
