...
<div class="king-exception-box king-500-page">
    ...
    <div style="text-align: left;margin-left:150px;">
	   	<p>前往“<a href="javascript:void(0);" onclick="redirect();" style="color: #2A73D0;" id="redirectLink">配置平台</a>”进行创建。</p>
	    <br/>
	    <p><a href="http://119.29.41.122/" target="_blank" style="color: #2A73D0; background:#CAE6FC;text-decoration: none;padding:8px;">体验Demo</a></p>
	 </div>
</div>
